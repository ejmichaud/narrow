...
#SBATCH --output=/n/home04/ericjm/narrow/experiments/pruneandtrain01/logs/slurm-%A_%a.out
...
def main():
    ...
    os.makedirs("/n/home04/ericjm/narrow/experiments/pruneandtrain01/logs", exist_ok=True)
    ...
    for neuron_sparsity, residual_sparsity in sparsity_configs:
        ...
        # Create output directory
        output_dir = f"{SCRATCH}/iaifi_lab/Lab/ericjm/narrow/pruneandtrain01/{config_name}"

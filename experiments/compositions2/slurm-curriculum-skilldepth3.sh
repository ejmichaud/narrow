...
python /om2/user/ericjm/narrow/experiments/compositions2/train-curriculum-skilldepth3.py \
    --width 128 \
    --depth $DEPTH \
    --seed $SEED \
    --verbose \
    --save-dir /om2/user/ericjm/narrow/experiments/compositions2/results/curriculum-skilldepth3-depth$DEPTH-seed$SEED

#!/bin/bash
#SBATCH --job-name=prune7
#SBATCH --ntasks=1
#SBATCH --time=2-00:00:00
#SBATCH --output=/om2/user/ericjm/narrow/experiments/tuneprune7/logs/slurm-%A_%a.out
...
python /om2/user/ericjm/narrow/tuneprune.py \
    ...
    --output_dir /om2/user/ericjm/narrow/experiments/tuneprune7/lambda_${sparsity_lambda} \

...
#SBATCH --output=/om2/user/ericjm/narrow/experiments/tuneprune7/base-weight/logs/slurm-%A_%a.out
#SBATCH --gres=gpu:1
...
python /om2/user/ericjm/narrow/experiments/tuneprune7/prune-abs.py \
    ...
    --streaming \
    --sparsity "${sparsity}" \
    --output_dir /om2/user/ericjm/narrow/experiments/tuneprune7/base-weight/sparsity_${sparsity} \

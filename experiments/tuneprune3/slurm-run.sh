...
#SBATCH --output=/om2/user/ericjm/narrow/experiments/tuneprune3/logs/slurm-%A_%a.out
...
python /om2/user/ericjm/narrow/tuneprune.py \
    ...
    --output_dir /om2/user/ericjm/narrow/experiments/tuneprune3/lambda_${sparsity_lambda} \

#!/bin/bash
#SBATCH --job-name=yolo9
#SBATCH --partition tegmark
#SBATCH --ntasks=1
#SBATCH --time=4-00:00:00
#SBATCH --output=/om2/user/ericjm/narrow/experiments/tuneprune9/logs/slurm-%A_%a.out
...
python /om2/user/ericjm/narrow/tuneprune-autoadjust.py \
    ...
    --output_dir /om2/user/ericjm/narrow/experiments/tuneprune9/yolo_lambda_${sparsity_lambda} \

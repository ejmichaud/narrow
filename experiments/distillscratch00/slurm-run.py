...
TEMPLATE = """#!/bin/bash
#SBATCH --job-name=distill_scratch
#SBATCH --partition=gpu
#SBATCH --gres=gpu:nvidia_a100-sxm4-80gb:1
#SBATCH --output=/n/home04/ericjm/narrow/experiments/distillscratch00/logs/slurm-%A_%a.out
#SBATCH --time={time_limit}
#SBATCH --ntasks=1
#SBATCH --mem=12GB

python $HOME/narrow/distillscratch.py \
...
def main():
    ...
    student_configs = [
        {"hidden_size": 256, "num_layers": 4, "num_heads": 4, "intermediate_size": 1024, "time_limit": "2-00:00:00", "batch_size": 16, "accumulations": 4},
        {"hidden_size": 512, "num_layers": 8, "num_heads": 8, "intermediate_size": 2048, "time_limit": "2-00:00:00", "batch_size": 16, "accumulations": 4},
        {"hidden_size": 768, "num_layers": 12, "num_heads": 12, "intermediate_size": 3072, "time_limit": "2-00:00:00", "batch_size": 8, "accumulations": 8},
        {"hidden_size": 864, "num_layers": 16, "num_heads": 16, "intermediate_size": 3456, "time_limit": "3-00:00:00", "batch_size": 8, "accumulations": 8},
        {"hidden_size": 1024, "num_layers": 16, "num_heads": 16, "intermediate_size": 4096, "time_limit": "3-00:00:00", "batch_size": 8, "accumulations": 8},
        {"hidden_size": 1280, "num_layers": 20, "num_heads": 20, "intermediate_size": 5120, "time_limit": "3-00:00:00", "batch_size": 4, "accumulations": 16},
    ...
    model_configs = [
        {**student_config, "teacher_model_name": teacher_model}
    ...
    for config in model_configs:
        ...
        output_dir = f"{SCRATCH}/iaifi_lab/Lab/ericjm/narrow/distillscratch00/d{config['hidden_size']}_l{config['num_layers']}_h{config['num_heads']}"

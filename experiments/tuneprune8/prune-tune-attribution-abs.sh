...
#SBATCH --output=/om2/user/ericjm/narrow/experiments/tuneprune7/tune-attribution-abs/logs/slurm-%A_%a.out
#SBATCH --gres=gpu:1
#SBATCH --constraint=24GB
#SBATCH --exclude node091
#SBATCH --mem=16GB
#SBATCH --array=8-11
...
python /om2/user/ericjm/narrow/experiments/tuneprune7/prune-abs.py \
    ...
    --streaming \
    --sparsity "${sparsity}" \
    --output_dir /om2/user/ericjm/narrow/experiments/tuneprune7/tune-attribution-abs/sparsity_${sparsity} \

#!/bin/bash
#SBATCH --job-name=prune8
#SBATCH --ntasks=1
#SBATCH --time=0-48:00:00
#SBATCH --output=/om2/user/ericjm/narrow/experiments/tuneprune8/logs/slurm-%A_%a.out
...
python /om2/user/ericjm/narrow/tuneprune-autoadjust.py \
    ...
    --output_dir /om2/user/ericjm/narrow/experiments/tuneprune8/lambda_${sparsity_lambda} \
